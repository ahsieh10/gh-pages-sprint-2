...
test("check processLoadData", () => {
  ...
  expect(main.processLoadData("manyColumnsLowRowsFile")).toBe(
    "File manyColumnsLowRowsFile loaded!"
  );
  expect(main.processLoadData("equalColumnRowFile")).toBe(
    "File equalColumnRowFile loaded!"
  );
  expect(main.processLoadData("oneColumnFile")).toBe(
    "File oneColumnFile loaded!"
  );
  expect(main.processLoadData("manyRowsLowColumnsFile")).toBe(
    "File manyRowsLowColumnsFile loaded!"
  );
  expect(main.processLoadData("emptyFile")).toBe(
    "File emptyFile loaded!"
  );
...
test("check processView", () => {
    // valid cases
    main.processLoadData("file1");
    let output = document.createElement("div");
    expect(main.processView(output).innerHTML.trim()).toBe(
      "<table><tbody><tr><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td>" +
    ...
    expect(main.processView(output).innerHTML.trim()).toBe(
      "<table><tbody><tr><td>this</td><td>is</td><td>a</td><td>one</td>" +
    ...
    output = document.createElement("div"); // refreshes output to be used again
    expect(main.processView(output).innerHTML.trim()).toBe(
      "<table><tbody><tr><td>this</td><td>is</td><td>a</td><td>high</td><td>"
...
test("check processView invalid cases", () => {
    let output = document.createElement("div");
...
test("check viewCSVData", () => {
    ...
    expect(main.viewCSVData(oneColumnFile).innerHTML.trim()).toBe(
      "<tbody><tr><td>1</td></tr><tr><td>2</td></tr><tr><td>3</td>" +
      "</tr><tr><td>4</td></tr></tbody>"
    );

    expect(main.viewCSVData(manyRowsLowColumnsFile).innerHTML.trim()).toBe(
      "<tbody><tr><td>a</td><td>b</td></tr><tr><td>e</td><td>p</td></tr><tr>" +
    ...
    expect(main.viewCSVData(emptyFile).innerHTML.trim()).toBe(
      "<tbody><tr></tr></tbody>"
    );
});

test("check getSearch", () => {
  expect(main.getSearch("file1", "2", "remains")).toBe(
      mockedQueryData.get("file1" + " " + "2" + " " + "remains")
    );

    expect(main.getSearch("equalColumnRowFile", "0", "a")).toBe(
      mockedQueryData.get("equalColumnRowFile" + " " + "0" + " " + "a")
    );
...
test("check processSearch", () => {
  // invalid case: CSV file has not been loaded in yet
  let output = document.createElement("div");
  expect(main.processSearch(output, ["search", "2", "remains"]).innerHTML.trim()
  ).toBe("<div></div>");
  ...
  expect(
    main.processSearch(output, ["search", "2", "remains"]).innerHTML.trim()
  ).toBe(
    "<div><table><tbody><tr><td>The</td><td>song</td><td>remains</td><td>" +
  ...
  output = document.createElement("div"); // refresh the output for this test
  expect(
    main.processSearch(output, ["search", "b", "p"]).innerHTML.trim()
  ).toBe(
    "<div><table><tbody><tr><td>e</td><td>p</td></tr><tr><td>o</td><td>p" +
  ...
  output = document.createElement("div"); // refresh the output for this test
  expect(
    main.processSearch(output, ["search", "1000", "p"]).innerHTML.trim()
  ).toBe(
    "<div></div>"
  );
  ...
  output = document.createElement("div"); // refresh the output for this test
  expect(
    main.processSearch(output, ["search", "2", "not.real...."]).innerHTML.trim()
  ).toBe("<div></div>");
  ...
  output = document.createElement("div"); // refresh the output for this test
  expect(
    main.processSearch(output, ["search", "0", ""]).innerHTML.trim()
  ).toBe("<div></div>");
...
test("check processCommand", () => {
  ...
  expect(main.processCommand("view").innerHTML.trim()).toBe(
    "<div></div><div></div>"
  );

  // search with valid input when file has not been loaded yet
  expect(main.processCommand("search 2 remains").innerHTML.trim()).toBe(
    "<div></div><div></div>"
  );

  // search without other inputs
  expect(main.processCommand("search").innerHTML.trim()).toBe(
    "<div></div><div></div>"
  );

  // load_file call without a valid file input
  expect(main.processCommand("load_file 1234fakefile").innerHTML.trim()).toBe(
    "<div></div><div></div>"
  );

  // valid load_file call
  expect(main.processCommand("load_file file1").innerHTML.trim()).toBe(
    "<div></div><div></div>"
  ); // note: the empty divs here are intentional; load_file does not actually
  ...
  // valid view call
  expect(main.processCommand("view").innerHTML.trim()).toBe(
    "<div></div><div></div><table><tbody><tr><td>1" +
      "</td><td>2</td><td>3</td><td>4</td><td>5</td></tr><tr><td>The</td><td>" +
  ...
  expect(main.processCommand("search 2 remains").innerHTML.trim()).toBe(
    "<div></div><div></div><div><table><tbody><tr><td>The</td><td>song</td><td>remains</td><td>" +
      "the</td><td>same.</td></tr></tbody></table></div>"
  );

  // invalid search call with properly loaded CSV file
  expect(main.processCommand("search 20000 fake.name.").innerHTML.trim()).toBe(
    "<div></div><div></div>"
  );
  ...
  expect(main.processCommand("view").innerHTML.trim()).toBe(
    "<div></div><div></div><table><tbody><tr><td>a</td><td>b</td></tr><tr><td>e</td><td>p</td></tr><tr>" +
      "<td>i</td><td>j</td></tr><tr><td>i</td><td>j</td></tr><tr><td>c</td>" +
      "<td>d</td></tr><tr><td>o</td><td>p</td></tr><tr><td>q</td><td>r</td>" +
      "</tr><tr><td>s</td><td>c</td></tr><tr><td>w</td><td>t</td></tr><tr>" +
      "<td>n</td><td>p</td></tr><tr><td>z</td><td>s</td></tr><tr><td>p</td>" +
  ...
  expect(main.processCommand("search b p").innerHTML.trim()).toBe(
    "<div></div><div></div><div><table><tbody><tr><td>e</td><td>p</td></tr><tr><td>o</td><td>p" +
      "</td></tr><tr><td>n</td><td>p</td></tr></tbody></table></div>"
  );
